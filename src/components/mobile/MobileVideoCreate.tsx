...
const MODELS: ModelOption[] = [
  ...
  { id: "kling-3.0", name: "Kling 3.0", description: "Latest with native audio", credits: 40, badge: "TOP", tier: "hq" },
  { id: "wan-2.6", name: "Wan 2.6", description: "Latest Alibaba model", credits: 15, badge: "HOT", tier: "hq" },
  { id: "veo-3", name: "Veo 3", description: "Google's best with audio", credits: 30, badge: "HOT", tier: "hq" },
  { id: "veo-3-fast", name: "Veo 3 Fast", description: "Faster Veo 3", credits: 20, badge: "PRO", tier: "hq" },
  { id: "luma", name: "Luma Dream Machine", description: "Creative video", credits: 22, badge: "HOT", tier: "hq" },
  { id: "seedance-pro", name: "Seedance Pro", description: "ByteDance high quality", credits: 22, tier: "hq" },
  ...
  { id: "kie-kling", name: "Kling 2.1", description: "Kuaishou video AI", credits: 12, badge: "HOT", tier: "economy" },
  { id: "kie-veo31", name: "Veo 3.1", description: "Google latest video", credits: 12, tier: "economy" },
  { id: "kie-grok", name: "Grok Imagine", description: "X.AI video gen", credits: 15, tier: "economy" },
  { id: "kie-sora2", name: "Sora 2", description: "OpenAI video gen", credits: 12, badge: "HOT", tier: "economy" },
  { id: "kie-sora2-pro", name: "Sora 2 Pro", description: "OpenAI best quality", credits: 18, tier: "economy" },
  { id: "kie-hailuo", name: "Hailuo", description: "MiniMax video", credits: 10, tier: "economy" },
  { id: "kie-hailuo-2.3", name: "Hailuo 2.3", description: "MiniMax latest", credits: 15, badge: "NEW", tier: "economy" },
  { id: "kie-wan", name: "Wan 2.2", description: "Alibaba video AI", credits: 8, tier: "economy" },
