  ...
  try {
    ...
    switch (action) {
      case "analyze_image": {
        ...
        logStep("Image analysis complete", { totalCalories: (result as AnalysisResult).total_calories });
        break;
      }
      ...
      case "analyze_text": {
        ...
        logStep("Text analysis complete", { totalCalories: (result as AnalysisResult).total_calories });
        break;
      }
      ...
      case "suggest_meals": {
        ...
        logStep("Meal suggestions complete", { count: (result as MealPlanResult).suggestions.length });
        break;
      }
