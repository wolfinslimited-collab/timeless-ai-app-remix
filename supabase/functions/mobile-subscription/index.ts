...
// These IDs work for BOTH iOS and Android - same format used across platforms
const FALLBACK_PRODUCT_MAPPINGS: Record<string, ProductMapping> = {
  // === CURRENT Product IDs (iOS App Store Connect & Google Play Console) ===
  "com.timeless.premium.monthly": { plan: "premium", credits: 500, type: "subscription" },
  "com.timeless.premium.yearly": { plan: "premium", credits: 5000, type: "subscription" },
  ...
  // === LEGACY Android Product IDs (dot-separated format) ===
