...
// Model configurations with actual logos - all using monochrome styling
const MODEL_CONFIG: Record<string, { 
  ...
  // Llama/Meta models
  "llama-3.3": { logo: metaLlamaLogo, bgColor: "bg-secondary", invert: false },
  "llama-3.3-large": { logo: metaLlamaLogo, bgColor: "bg-secondary", invert: false },
};
