...
class HomeProvider extends ChangeNotifier {
  ...
  List<FeaturedItem> _getFallbackItems() {
    const baseUrl =
        'https://timeless-bucket.fra1.cdn.digitaloceanspaces.com/ai_agent_timeless';
    return [
      FeaturedItem(
        id: '1',
        title: 'Cinema Studio',
        ...
        tag: 'Featured',
        videoUrl:
            '$baseUrl/47f98df2-8f0d-4cf0-a32f-f582f3c0f90f-video11080.1080.mp4',
        displayOrder: 1,
        linkUrl: '/cinema',
      ),
      FeaturedItem(
        ...
        tag: 'Popular',
        videoUrl:
            '$baseUrl/25bd0bda-0068-47e9-a2c3-c51330245765-video21080.1080 - RESIZE - Videobolt.net.mp4',
        displayOrder: 2,
      ...
      FeaturedItem(
        ...
        tag: 'New',
        videoUrl:
            '$baseUrl/559a3bef-5733-4be4-b79b-324924945429-video31080.1080 - RESIZE - Videobolt.net.mp4',
        displayOrder: 3,
      ...
      FeaturedItem(
        ...
        tag: 'Hot',
        videoUrl:
            '$baseUrl/33ee7581-6b7d-4d50-87d0-98acd87a53f3-video41080.1080 - RESIZE - Videobolt.net.mp4',
        displayOrder: 4,
      ...
      FeaturedItem(
        ...
        tag: 'New',
        videoUrl:
            '$baseUrl/d49d2f58-acca-48f6-b890-2cf2443c4bba-style-transfer-preview-ezgif.com-resize-video.mp4',
        displayOrder: 5,
