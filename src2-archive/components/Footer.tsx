...
const Footer = () => {
  ...
  const socialLinks = [
    { label: "Youtube", href: "https://www.youtube.com/@timelessaiapp" },
    { label: "Instagram", href: "https://www.instagram.com/timelessapp.ai/" },
    { label: "TikTok", href: "https://www.tiktok.com/@timelessapp.ai" },
    { label: "Discord", href: "https://discord.gg/xuaQTdGm4s" },
    { label: "Telegram", href: "https://t.me/timelessai" },
  ];
